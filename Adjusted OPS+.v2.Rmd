...
combined_files_all_years <- multi_union_all("/Users/maxhoff/Documents/Sabremetrics/Adjusted OPS+/retrosheet_data/play_by_play_logs")
```
...
play_key <- unique(read_csv("/Users/maxhoff/Documents/Sabremetrics/play_key_v2.csv"))
```
...
```{r}
##roll up play log by team by home and away games in order to start creating ball park factors
##calculate slugging and obp
##difference in OPS between home and away fields will be basis of ball park factor calcs
...
rosters_all_years <- distinct(multi_union_all("/Users/maxhoff/Documents/Sabremetrics/Adjusted OPS+/retrosheet_data/team_rosters"))
```
